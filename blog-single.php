...
include('connection/db.php');
  ...
  $query = mysqli_query($conn,"select * from all_jobs where id='$id' ");
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Job View</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-6 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Apply form</h3>
                <form action="apply_job.php" method="post" name="applyjobform" id="applyjobform" enctype="multipart/form-data"     class="p-5 bg-light">
                  ...
                  <div class="form-group">
                    <label for="file">Add resume</label>
